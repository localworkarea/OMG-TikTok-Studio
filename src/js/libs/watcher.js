...
class ScrollWatcher {
	...
	scrollWatcherIntersecting(entry, targetElement) {
		if (entry.isIntersecting) {
			// Бачимо об'єкт
			// Додаємо клас
			!targetElement.classList.contains('_visible') ? targetElement.classList.add('_visible') : null;
			// this.scrollWatcherLogging(`Я бачу ${targetElement.classList}, додав клас _visible`);
		} else {
			// Не бачимо об'єкт
			// Забираємо клас
			targetElement.classList.contains('_visible') ? targetElement.classList.remove('_visible') : null;
