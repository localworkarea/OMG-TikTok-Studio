...
import { isMobile,_slideToggle, _slideUp, _slideDown, menuOpen, menuClose, bodyLockStatus, bodyLockToggle, handleMenuVisibility} from "./functions.js";
...
document.addEventListener("DOMContentLoaded", () => {
	...
	handleMenuVisibility(); // Функция находится в файле ./function.js
	setupMenuToggle();
