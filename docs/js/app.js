(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-block__slider")) new Swiper(".slider-block__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    class ScrollWatcher {
        ...
        scrollWatcherIntersecting(entry, targetElement) {
            if (entry.isIntersecting) !targetElement.classList.contains("_visible") ? targetElement.classList.add("_visible") : null; else targetElement.classList.contains("_visible") ? targetElement.classList.remove("_visible") : null;
        }
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        navFooterSublists.forEach((sublist => {
            ...
            if (navFooterLink) navFooterLink.addEventListener("click", (function(e) {
                e.preventDefault();
            }));
        }));
        ...
        function setupMenuToggle() {
            menuItemsWithSublist.forEach((item => {
                ...
                const sublist = item.querySelector(".menu__sublist");
                if (link && sublist) link.addEventListener("click", (e => {
                    e.preventDefault();
                    if (mediaQuery992max.matches) if (sublist.hidden) {
            ...
            menuIcon.addEventListener("click", (e => {
                if (mediaQuery992max.matches) {
                    ...
                    if (bodyLockStatus && e.target.closest(".icon-menu")) {
                        ...
                        if (menuBody.hidden) _slideDown(menuBody, 300); else {
        ...
        if (scrollUpBtn) {
            const toggleScrollUpButton = () => {
                if (window.scrollY > 300) scrollUpBtn.classList.add("_show"); else scrollUpBtn.classList.remove("_show");
            };
    ...
    document.addEventListener("focusin", (async function(event) {
        ...
        if (input.hasAttribute("data-mask") && !input.dataset.masked) {
            ...
            const mask = lang === "uk" || lang === "ru" ? "+38 (999) 99 99" : "+99 999 99 99";
            Inputmask({
                mask,
